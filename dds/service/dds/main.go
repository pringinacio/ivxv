...
// Deprecated: dds is not used anymore by IVXV backend.
/*
...
// ddsToServerError maps an ivxv.ee/common/collector/dds package error to an ivxv.ee/common/collector/server
